...
function atualizarCarrinho(){
    ...
    carrinho.forEach((produto,index) => {
        ...
        `<div
        id='produto${index}'
            class='d-flex flex-row justify-content-between align-items-center pt-lg-12 pt-md-12 pt-12 pb-3 border-botton mobile'
        >
...
function atualizaSubtotal(){
    ...
    totalCompra.innerHTML = subtotal.toFixed
}
